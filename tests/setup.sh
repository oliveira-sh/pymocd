...
case "${1:-}" in
  ...
  --experiment)
    ...
    python3 tests/benchmarks/lfr_experiment.py > experiment.out
    echo "[OK] Experiment finished. See experiment.out."
    ;;
  --ga-params)
    setup
    echo "[..] Running Genetic Algorithm params experiment"
    python3 tests/benchmarks/params.py > experiment.out
    echo "[OK] Experiment finished. See experiment.out."   
    ;;
  --pareto-frontier)
    setup
    echo "[..] Running Pareto-front experiment and writing to experiment.out…"
    python3 tests/benchmarks/pareto_front.py > experiment.out
    echo "[OK] Experiment finished. See experiment.out."
    ;;
  -h|--help)
    usage
