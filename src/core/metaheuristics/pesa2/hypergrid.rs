...
impl Solution {
    /// Pareto dominance: both objectives minimised, so lower is better.
...
/// Roulette selection weighted by inverse hyperbox density (favours sparse regions).
