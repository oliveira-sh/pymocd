//! Micro variation: the label graft or ensemble-consensus crossover, followed
//! by uniform or similarity-weighted neighbour mutation.
...
use crate::core::algorithms::smocc::config::MicroOps;
...
mod tests {
    use super::*;
    use crate::core::algorithms::smocc::config::topo::{TOPO_HPMOCD_CROSS, TOPO_MAJORITY_MUT};
    use crate::core::graph::CsrGraph;
